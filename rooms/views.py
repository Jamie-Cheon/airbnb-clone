        ...
        if country:
            ...
            if form.is_valid():
                ...
                for amenity in amenities:
                    filter_args["amenities__in"] = amenity
...
class EditRoomView(user_mixins.LoggedInOnlyView,
                   UpdateView):
    ...
    def get_object(self, queryset=None):
        ...
        # raise error when users(not a host) access rooms:edit direct url
        if room.host.pk != self.request.user.pk:
            raise Http404()
        return room


class RoomPhotosView(user_mixins.LoggedInOnlyView,
                     DetailView):
